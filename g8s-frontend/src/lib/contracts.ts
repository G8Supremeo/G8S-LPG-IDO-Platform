...
export const CONTRACTS = {
  G8S_TOKEN_ADDRESS: process.env.NEXT_PUBLIC_G8S_TOKEN_ADDRESS || "",
  IDO_ADDRESS: process.env.NEXT_PUBLIC_IDO_ADDRESS || "",
  PUSD_ADDRESS: process.env.NEXT_PUBLIC_PUSD_ADDRESS || "0xDd7639e3920426de6c59A1009C7ce2A9802d0920",
} as const;
